...
<div class="container-fluid" style="height: 650px">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal">Tambah Jenis Obat</button>
                    </div>
                </div>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                @foreach($data as $datas)
                                    <tr>
                                        ...
                                        <td>{{ $datas->jenis }}</td>
                                        <td>
                                            <form method="POST" action="/{{ $datas->id }}/deletejenis">
                                        <a href="/{{ $datas->id }}/editjenis" class="btn btn-success btn-xs">
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form role="form" method="POST" action="{{ url('/tambahjenis') }}">
                                    {{ csrf_field() }}
                                        <div class="form-group">
                                            <label for="Nama">Jenis Obat :</label>
                                            <input class="form-control" id="Nama" name="jenis" type="text" placeholder="Jenis Obat">
                                        </div>
